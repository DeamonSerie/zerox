...
void z_aarch64_emit_eor_x_reg(ZBuf *text, unsigned dst, unsigned lhs, unsigned rhs) {
  z_aarch64_append_u32(text, 0xca000000u | ((rhs & 31u) << 16) | ((lhs & 31u) << 5) | (dst & 31u));
}

void z_aarch64_emit_lsl_w_reg(ZBuf *text, unsigned dst, unsigned lhs, unsigned rhs) {
  z_aarch64_append_u32(text, 0x1ac02000u | ((rhs & 31u) << 16) | ((lhs & 31u) << 5) | (dst & 31u));
}

void z_aarch64_emit_lsl_x_reg(ZBuf *text, unsigned dst, unsigned lhs, unsigned rhs) {
  z_aarch64_append_u32(text, 0x9ac02000u | ((rhs & 31u) << 16) | ((lhs & 31u) << 5) | (dst & 31u));
}

void z_aarch64_emit_lsr_w_reg(ZBuf *text, unsigned dst, unsigned lhs, unsigned rhs) {
  z_aarch64_append_u32(text, 0x1ac02400u | ((rhs & 31u) << 16) | ((lhs & 31u) << 5) | (dst & 31u));
}

void z_aarch64_emit_lsr_x_reg(ZBuf *text, unsigned dst, unsigned lhs, unsigned rhs) {
  z_aarch64_append_u32(text, 0x9ac02400u | ((rhs & 31u) << 16) | ((lhs & 31u) << 5) | (dst & 31u));
}

void z_aarch64_emit_ror_w_reg(ZBuf *text, unsigned dst, unsigned lhs, unsigned rhs) {
  z_aarch64_append_u32(text, 0x1ac02c00u | ((rhs & 31u) << 16) | ((lhs & 31u) << 5) | (dst & 31u));
}

void z_aarch64_emit_ror_x_reg(ZBuf *text, unsigned dst, unsigned lhs, unsigned rhs) {
  z_aarch64_append_u32(text, 0x9ac02c00u | ((rhs & 31u) << 16) | ((lhs & 31u) << 5) | (dst & 31u));
}
