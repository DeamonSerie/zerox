...
const ZStdHelperInfo z_std_helpers[] = {
  ...
  /* std.crypto.cipher metadata helpers (pure zero implementations in .0 files) */
  ...
  {"std.crypto.chacha.chacha20Poly1305Encrypt", "u32", 6, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.chacha.chacha20Poly1305Decrypt", "u32", 6, "codec", "target-neutral", "writes caller buffer", true},
  ...
  {"std.crypto.des.decrypt", "u32", 5, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.des.tripleEncrypt", "u32", 5, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.des.tripleDecrypt", "u32", 5, "codec", "target-neutral", "writes caller buffer", true},

  /* std.crypto.blowfish block cipher */
  {"std.crypto.blowfish.encrypt", "u32", 6, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.blowfish.decrypt", "u32", 6, "codec", "target-neutral", "writes caller buffer", true},

  /* std.crypto.twofish block cipher */
  {"std.crypto.twofish.encrypt", "u32", 6, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.twofish.decrypt", "u32", 6, "codec", "target-neutral", "writes caller buffer", true},

  /* std.crypto.serpent block cipher */
  {"std.crypto.serpent.encrypt", "u32", 6, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.serpent.decrypt", "u32", 6, "codec", "target-neutral", "writes caller buffer", true},

  /* std.crypto.camellia block cipher */
  {"std.crypto.camellia.encrypt", "u32", 6, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.camellia.decrypt", "u32", 6, "codec", "target-neutral", "writes caller buffer", true},

  /* std.crypto.rsa asymmetric */
  {"std.crypto.rsa.generateKeyPair", "u32", 4, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.rsa.encrypt", "u32", 5, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.rsa.decrypt", "u32", 5, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.rsa.sign", "u32", 6, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.rsa.verify", "Bool", 6, "codec", "target-neutral", "no allocation", true},

  /* std.crypto.ecc asymmetric */
  {"std.crypto.ecc.generateKeyPair", "u32", 4, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.ecc.sign", "u32", 5, "codec", "target-neutral", "writes caller buffer", true},
  {"std.crypto.ecc.verify", "Bool", 5, "codec", "target-neutral", "no allocation", true},
