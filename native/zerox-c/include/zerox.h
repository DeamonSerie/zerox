#ifndef ZERO_C_ZEROX_H
#define ZERO_C_ZEROX_H
...
typedef enum {
  ...
  IR_VALUE_CHECK,
  IR_VALUE_RESCUE,
  IR_VALUE_CRYPTO_HELPER
} IrValueKind;

/* Crypto operation codes for IR_VALUE_CRYPTO_HELPER */
#define CRYPTO_SHA256       1
#define CRYPTO_HMAC_SHA256  2
#define CRYPTO_AES_ENCRYPT  3
#define CRYPTO_AES_DECRYPT  4
#define CRYPTO_CHACHA20     5
#define CRYPTO_PBKDF2       6
#define CRYPTO_RANDOM_BYTES 7
#define CRYPTO_SHA512       8
#define CRYPTO_SALSA20      9
#define CRYPTO_CHACHA20_POLY1305_ENCRYPT 10
#define CRYPTO_CHACHA20_POLY1305_DECRYPT 11
#define CRYPTO_DES_ENCRYPT     12
#define CRYPTO_DES_DECRYPT     13
#define CRYPTO_TDES_ENCRYPT    14
#define CRYPTO_TDES_DECRYPT    15
#define CRYPTO_BLOWFISH_ENCRYPT 16
#define CRYPTO_BLOWFISH_DECRYPT 17
#define CRYPTO_TWOFISH_ENCRYPT  18
#define CRYPTO_TWOFISH_DECRYPT  19
#define CRYPTO_SERPENT_ENCRYPT  20
#define CRYPTO_SERPENT_DECRYPT  21
#define CRYPTO_CAMELLIA_ENCRYPT 22
#define CRYPTO_CAMELLIA_DECRYPT 23
#define CRYPTO_RSA_GENERATE_KEYPAIR 24
#define CRYPTO_RSA_ENCRYPT      25
#define CRYPTO_RSA_DECRYPT      26
#define CRYPTO_RSA_SIGN         27
#define CRYPTO_RSA_VERIFY       28
#define CRYPTO_ECC_GENERATE_KEYPAIR 29
#define CRYPTO_ECC_SIGN         30
#define CRYPTO_ECC_VERIFY       31
