#ifndef ZERO_C_ZEROX_AI_H
#define ZERO_C_ZEROX_AI_H

#include <stdbool.h>
#include <stddef.h>

/*
 * zerox_ai.h — Dynamic Compilation Control for ZeroxLang
 *
 ...
 *   --ai-control <path> or ZEROX_AI_CONTROL env var). The compiler reads
